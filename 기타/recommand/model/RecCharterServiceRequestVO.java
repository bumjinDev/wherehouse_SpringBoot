...
public class RecCharterServiceRequestVO {
	
	@NotNull(message = "전세금 평균 금액 입력은 필수 입니다.")
	@Min(value = 15000, message = "전세 평균 금액은 15000 이상이어야 합니다.")
	@Max(value = 30000, message = "전세 평균 금액은 30000 이하이어야 합니다.")
	int charter_avg;
