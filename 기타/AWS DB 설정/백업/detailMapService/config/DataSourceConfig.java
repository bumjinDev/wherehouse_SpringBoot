...
public class DataSourceConfig {
    ...
    @EnableJpaRepositories(
            basePackages = "com.aws.database.detailMapService.source", // Source DB용 Repository 패키지
    ...
    @EnableTransactionManagement
    @EnableJpaRepositories(
            basePackages = "com.aws.database.detailMapService.destination", // Destination DB용 Repository 패키지
