	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		%>
			...
			<body>
				...
				[게시글 수정]
				1. 게시글 수정 요청.
				2. 성공 혹은 거부에 따라 HTTP 상태 코드 확인하여 수정 따른 게시글 페이지로 분기 또는
					잘못된 요청이라는 alert 내용 확인.
				-->
				<h1 class="maintitle">게시글 수정 페이지</h1>

				<input type="hidden" id="boardId" name="boardId" value="<%=boardId %>" />  	<!-- 게시글 ID -->
				<!-- 글 제목 : 'name="title"' -->
				...
				<div class="headerTitle">
					<table>
						<tr>
							<th class="titleitem"><h5>게시글 제목</h5></th><th ><textarea id="boardTitle" class="posttitle" name="title"><%=title %></textarea></th>
						</tr>
					</table>
				</div>
				...
				<table class="headerTbl">
					...
					<tr>
						<th class="attributeBox">게시글 지역</th>
							<th class="valueBox">
								<select id="boardRegion" name="region" class="regions">						<!-- 게시글 선택 지역 -->
				...
				<div class="boardContent">
					<table>
						<tr>
							<th class="boardth"><div class="boardtext">글 본문 수정</div></th><th class="boardpost"><textarea rows="10" cols="54" id="boardContent" class="bcontent"><%=boardContent %></textarea>		<!-- 게시글 본문 --></th>
						</tr>
					</table>
				</div>
				<button value="글 수정 완료" type="submit" id="pageEdit" class="editbutton" style="width:100px; heigth:50px;">
					수정 완료</button>

				<button value="전체 글 목록 이동" type="button" id="pageList" class="listbutton" style="width:100px; heigth:50px;">
