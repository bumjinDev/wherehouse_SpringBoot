                ...
                <div class="filter_box">
                    ...
                    <div class="filter_item">
                        ...
                        <input type="text" class="filter_select" id="filter_property_name"
                               placeholder="예: 삼성아파트" maxlength="50">
            ...
            <div class="modal_body">
                <form id="review_form">
                    ...
                    <div class="form_group">
                        ...
                        <input type="text" id="input_property_id" placeholder="32자 MD5 Hash 입력" maxlength="32" required>
                        <div class="form_desc">매물의 고유 식별자 (32자)</div>
                    </div>

                    <div class="form_group">
                        <label for="input_user_id">사용자 ID <span class="required">*</span></label>
                        <input type="text" id="input_user_id" placeholder="user_ID" maxlength="50" required>
                    </div>
