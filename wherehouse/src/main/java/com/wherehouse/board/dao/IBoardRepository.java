...
public interface IBoardRepository {
	...
	public List<BoardEntity> searchBoardList(int pnIndex);		// 페이지 네이션 요청에 맞게 게시판 목록 제공.
	public void boardWrite(BoardEntity boardEntity);							// 게시판 글 작성.
	public Optional<BoardEntity> findBoard(int boardId);							// 선택한 게시판의 내용 제공.(게시판 Id로 선택)
	public int upHit(int boardId);										// 선택한 게시글에 대한 조회수 증가.
