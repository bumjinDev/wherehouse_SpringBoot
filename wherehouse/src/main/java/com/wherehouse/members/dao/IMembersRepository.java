...
public interface IMembersRepository {
	...
	public int addMember(MembersVO membersVO, UserEntity userEntity);			// confimMember() 실행 시 이상 없으면 회원 가입 진행.
	public MembersVO getMember(String userId);						// modify.jsp 페이지 제공 위한 MembersVO
	public int editMember(MembersVO memberVO, UserEntity userEntity);					// 회원정보 수정.
}
