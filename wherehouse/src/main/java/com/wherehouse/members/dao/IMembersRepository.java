...
public interface IMembersRepository {
	...
	public int addMember(MembersEntity membersEntity, AuthenticationEntity userEntity);			// confimMember() 실행 시 이상 없으면 회원 가입 진행.
	public MembersEntity getMember(String userId);						// modify.jsp 페이지 제공 위한 MembersVO
	public int editMember(MembersEntity memberVO, AuthenticationEntity userEntity);					// 회원정보 수정.
}
