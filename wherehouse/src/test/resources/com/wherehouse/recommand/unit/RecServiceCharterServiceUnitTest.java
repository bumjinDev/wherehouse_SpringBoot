...
class RecServiceCharterServiceUnitTest {
    ...
    @Test
    void RecommendationCharterUnitTest() {
    	
    	// 전세금 테스트 시 호출되는 레포지토리 : 전세금 15000 만원 / 안정성 5점 / 편의성 점수 5 으로 요청 시 
        when(recServiceEmpRepository.chooseCharterRec(15000, 5, 5)).thenReturn(mockRecServiceVO);
        ...
        verify(recServiceEmpRepository, times(1)).chooseCharterRec(15000, 5, 5);
    }
}
