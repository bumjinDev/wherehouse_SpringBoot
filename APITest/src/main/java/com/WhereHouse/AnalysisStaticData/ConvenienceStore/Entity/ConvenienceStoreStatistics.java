...
public class ConvenienceStoreStatistics {
    ...
    // ConvenienceStoreStatistics.java 및 BankStatistics.java
    @Column(name = "LONGITUDE", precision = 25, scale = 10) // 예시: 크기를 넉넉하게 확장
    private BigDecimal longitude;

    @Column(name = "LATITUDE", precision = 25, scale = 10)  // 예시: 크기를 넉넉하게 확장
