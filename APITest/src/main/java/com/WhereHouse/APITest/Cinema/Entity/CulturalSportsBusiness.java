...
public class CulturalSportsBusiness {
    ...
    @Column(name = "EMERGENCY_STAIRS", length = 10)
    private String emergencyStairs;

    @Column(name = "EMERGENCY_EXIT", length = 10)
    private String emergencyExit;

    @Column(name = "AUTO_VENTILATION", length = 10)
    private String autoVentilation;

    @Column(name = "YOUTH_ROOM_EXISTS", length = 10)
    private String youthRoomExists;

    @Column(name = "SPECIAL_LIGHTING", length = 10)
    private String specialLighting;

    @Column(name = "SOUNDPROOF_FACILITY", length = 10)
    private String soundproofFacility;

    @Column(name = "VIDEO_PLAYER_NAME", length = 200)
    private String videoPlayerName;

    @Column(name = "LIGHTING_FACILITY", length = 10)
    private String lightingFacility;

    @Column(name = "SOUND_FACILITY", length = 10)
    private String soundFacility;

    @Column(name = "CONVENIENCE_FACILITY", length = 10)
    private String convenienceFacility;

    @Column(name = "FIRE_SAFETY_FACILITY", length = 10)
