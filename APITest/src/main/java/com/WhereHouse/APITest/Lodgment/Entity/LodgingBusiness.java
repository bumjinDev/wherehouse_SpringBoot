...
public class LodgingBusiness {
    ...
    @Column(name = "LOCATION_PHONE", length = 100)
    ...
    @Column(name = "COORD_X", precision = 15, scale = 10)
    private BigDecimal coordX = BigDecimal.ZERO;

    @Column(name = "COORD_Y", precision = 15, scale = 10)
    ...
    @Column(name = "CONDITIONAL_PERMIT_REASON", length = 1000)
