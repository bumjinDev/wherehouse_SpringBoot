...
**action** (String): 메서드 내에서 수행되는 구체적인 하위 동작 이나 이벤트의 이름(예: "findCctvByGeohashIdIn", "calculateDistanceLoop"). START/END 로그를 정확히 짝지거나, 하나의 메서드 내에서도 여러 단계의 성능을 세분화하여 측정하고 싶을 때 유용하다.
