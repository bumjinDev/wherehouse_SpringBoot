 ...
 * 전세 매물 엔티티
 *
 * 설계 명세서: 7.1.1 A. PROPERTIES_CHARTER
 * 용도: 전세 매물의 마스터 데이터 저장 (Oracle RDB)
...
public class PropertyCharter {
     ...
     * @return RDB 저장용 PropertyCharter 엔티티
     */
    public static PropertyCharter from(Property dto) {
        return PropertyCharter.builder()
